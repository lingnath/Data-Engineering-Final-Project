...
## 6. (If necessary) Recreate Nifi DBCPConnectionPool
...
## 7. Check if mysql is working
  - docker exec -it mysql bash
  - mysql -u root -p
  - Enter "debezium" as password
  - use demo;
  - select * from bus_status limit 10;
## 8. Check if kafka is connected to debezium
...
## 10. Create Dashboards on Superset
